(ns stars.hardware.nano.state-maps
  (:use [stars.engine.timed]
        [stars.hardware.nano.stateful-device]
...
;; new state-map
;; (def state-maps (agent {:states {0 {:mixer    {:state (nk-state-map
;; 0)
;;                                                :button-id :s0}
;;                                     :grumbles {:state (nk-state-map
;; 0)
;;                                                :button-id :s1}}

;;                                  1 {:mixer    {:state (nk-state-map
;;                                  0)
;;                                                :button-id :s4}
;;                                     :bar {:state (nk-state-map 0)
;;                                           :button-id :s0}}}
;;                         :nks   {(first nano-kons) {:syncs
;;                                  (nk-state-map false)
;;                                                    :flashers
;;                                  (nk-state-map nil)
;;                                                    :current      [0
