...
;; (def nano2-fns {:slider0 (fn [v mixer-g] (println :RUNNING v) (ctl mixer-g :rev-mix v))
...
(def nano2-fns {:slider0 (fn [v sin-ctl-s] (println "HIITED") (ctl sin-ctl-s :amp-0 v))
...
(defn nkmx
  ([k] (nkmx 16 k)) ;; TODO replace 16 with a more sensible call i.e.
  ;; nk-bank
  ([bank k]
